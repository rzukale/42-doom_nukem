...
SRCS = \
	...
	editor$(SLASH)draw_editor_entity_links.c \
	...
	editor$(SLASH)editor_edit_gravity.c \
	...
	editor$(SLASH)editor_create_elevator3.c \
	...
	update_screen$(SLASH)check_for_valid_draw_range.c \
	...
	utilities$(SLASH)get_map_maximum_values.c \
